...
```text
latch:///copro_integration_analysis/{project_name}
```

`project_name` is the value supplied to the workflow. A temporary preprocessing checkpoint is written during the run under `copro_integration_analysis/{project_name}/preprocess`, but the finalization task attempts to delete it after successful completion.
...
```text
copro_integration_analysis/{project_name}/tables/
```
...
```text
copro_integration_analysis/{project_name}/figures/
```
...
```text
copro_integration_analysis/{project_name}/figures/clustering/
```
...
```text
copro_integration_analysis/{project_name}/figures/genes_of_interest/
```
...
```text
copro_integration_analysis/{project_name}/Launch_Plots/artifact.json
```
...
```text
copro_integration_analysis/{project_name}/coverages/
```
...
```text
copro_integration_analysis/{project_name}/peak2gene/
```
